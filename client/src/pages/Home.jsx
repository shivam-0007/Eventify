        ...
        <div className="flex flex-col min-h-screen">
            ...
            <div className="relative bg-black text-white rounded-3xl overflow-hidden mb-12 shadow-2xl">
                ...
                <div className="relative p-10 md:p-20 text-center flex flex-col items-center z-10">
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-10">
                        <Link to="/register" className="inline-flex items-center justify-center rounded-full bg-white px-8 py-3 text-sm font-semibold text-gray-900 shadow-lg shadow-black/10 transition hover:bg-gray-100">
                            Join Eventify
                        </Link>
                        <Link to="/login" className="inline-flex items-center justify-center rounded-full border border-white/40 bg-black/20 px-8 py-3 text-sm font-semibold text-white transition hover:bg-white/10">
                            Login to book
                        </Link>
                    </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16 px-4">
                ...
                <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100 flex flex-col items-center text-center hover:-translate-y-1 transition duration-300">
                    ...
                    <p className="text-gray-500 text-sm leading-relaxed">Download tickets instantly or manage them right from your personal dashboard with ease.</p>
                </div>
                <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100 flex flex-col items-center text-center hover:-translate-y-1 transition duration-300">
                    <div className="w-16 h-16 bg-gray-900 text-white rounded-2xl flex items-center justify-center text-2xl mb-6 shadow-md shadow-gray-200/50">
                        <FaShieldAlt />
                    ...
                    <p className="text-gray-500 text-sm leading-relaxed">All transactions and registrations are protected by cutting-edge security and 2FA OTP authentication.</p>
                </div>
            </div>
